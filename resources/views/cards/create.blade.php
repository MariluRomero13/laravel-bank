	...
	<div class="container-fluid spark-screen">
		<div class="row">
			...
			<div class="col-md-7">
				<div class="box">
					<div class="box-header with-border">
						<h3 class="box-title">Registrar tarjeta</h3>
					</div>
                    <form action="{{ route('tarjetas.store') }}" method="POST">
					    ...
					    <div class="box-body">
                            ...
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                <input type="date" class="form-control" placeholder="Fecha de expiración" name="expiration_date" required>
                            </div> <br>
                        </div>
                        <div class="box-footer">
                            ...
                            <a type="button" class="btn btn-default pull-left" href="{{ route('tarjetas.index') }}">
