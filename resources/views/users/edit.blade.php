                    ...
                    <form action="{{ route('usuarios.update', $user->id) }}" method="POST">
					    <div class="box-body">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" placeholder="Nombre de usuario" id="name" name="name" required autofocus value="{{ $user->name }}">
                            </div><br>
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-envelope"></i></span>
                                <input type="email" disabled class="form-control" placeholder="Correo" id="email" name="email" required autofocus value="{{ $user->email }}">
                            </div><br>
                            <div class="input-group">
